...
router.post('/send-otp', registerSendOtp, blockTempMail, controller.sendOtp);
...
router.get('/alumni-organizations', controller.listAlumniOrganizations);
router.post('/alumni/send-otp', registerSendOtp, blockTempMail, controller.sendAlumniOtp);
router.post('/alumni/verify-otp', registerVerifyOtp, controller.verifyAlumniOtp);
router.post('/alumni/submit', registerSubmit, blockTempMail, controller.submitAlumniRequest);
