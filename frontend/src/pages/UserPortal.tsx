...
export default function UserPortal() {
  ...
  const isAlumniPath = location.pathname === "/alumni";
  const initialTab =
    searchParams.get("tab") || (isAlumniPath ? "directory" : "card");
  ...
  const isAlumniExperience = isAlumniPath || actor?.role === "alumni";
  const navTabs = isAlumniExperience ? ALUMNI_TABS : TABS;
  ...
  return (
    <OrgThemeProvider>
      ...
      >
        ...
        <aside
          style={{
            width: isCompactLayout ? "min(340px, 88vw)" : desktopSidebarWidth,
            flexShrink: 0,
            background: "var(--color-bg-secondary)",
              ...
              >
                <div
                  style={{
                    ...
                    height: "100%",
                    background:
                      "linear-gradient(90deg, var(--color-brand), #10B981)",
                    borderRadius: 2,
            ...
            >
              ...
              {memoryUsage?.plan === "free" ? (
                <>
                  ...
                  >
                    Remaining this month: {memoryUsage?.remaining_photos ?? 0}{" "}
                    photos, {memoryUsage?.remaining_videos ?? 0} videos.
                  </p>
                </>
              ) : (
                <p
        ...
        >
          {isCompactLayout && (
            ...
            >
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                ...
                >
                  {navTabs.find((item) => item.key === tab)?.label || "Portal"}
                </div>
              </div>
          ...
          {tab === "card" && (
            ...
            >
              ...
              <div
                style={{
                  width: isCompactLayout ? "100%" : 288,
                  flexShrink: 0,
                  borderLeft: isCompactLayout
                    ? "none"
                    : "1px solid var(--color-border-subtle)",
                  borderTop: isCompactLayout
                    ? "1px solid var(--color-border-subtle)"
                    : "none",
                  padding: isCompactLayout ? "20px 16px 28px" : "28px 20px",
                  overflowY: "auto",
                  display: "flex",
                  flexDirection: "column",
                  gap: 16,
          ...
          {tab === "memories" && (
            <div
              style={{
                padding: isCompactLayout ? "20px 16px 28px" : "28px 36px",
              }}
            >
                ...
                >
                  ...
                  {actor?.role === "user" && (
                    ...
                    >
                      ...
                      >
                        Request alumni status. Your admin must approve this
                        request.
                      </p>
                      <button
                        onClick={async () => {
                          ...
                          try {
                            const { data } = await api.post(
                              "/register/alumni/request-upgrade",
                              {
                                reason: "Requested from profile section",
                              },
                            );
                            toast(
                              data.message || "Alumni request submitted",
                              "success",
                            );
                          } catch (err: any) {
                            toast(
