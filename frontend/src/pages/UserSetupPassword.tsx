...
export default function UserSetupPassword() {
  ...
  const handleSetup = async () => {
    ...
    try {
      ...
      setSuccess(true);
      toast("Password successfully set! Redirecting to login...", "success");
      setTimeout(() => navigate("/login"), 1500);
    } catch (err: any) {
      toast(err.response?.data?.error || "Failed to set password", "error");
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        {success ? (
          <div style={{ textAlign: "center" }}>
            <CheckCircle
              size={40}
              style={{ color: "#22C55E", marginBottom: 16, margin: "0 auto" }}
            />
            ...
            >
              Your password has been set. You can now log in to access your portal.
            </p>
            <button
              onClick={() => navigate("/login")}
              style={{
          ...
          <>
            ...
            >
              Create a secure password for your new account to log in.
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{ ...inputStyle, paddingRight: 42 }}
                  onKeyUp={(e) => e.key === "Enter" && handleSetup()}
                />
                <button
                  tabIndex={-1}
