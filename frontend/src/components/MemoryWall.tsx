...
export default function MemoryWall({
  ...
  const handleDelete = (e: React.MouseEvent, memoryId: number) => {
    e.stopPropagation();
    if (
      window.confirm("Delete this memory permanently? This cannot be undone.")
    ) {
                ...
                {REACTIONS.map((emoji) => (
                  <button
                    ...
                    style={{
                      ...
                      background: m.viewer_reactions?.includes(emoji)
                      ...
                      color: m.viewer_reactions?.includes(emoji)
                        ? "var(--color-brand)"
